    ...
    public static function base_translate_content()
    {
        $global = [
            ///// MESSAGES /////
              ...
              "messages.register.success.unverified.msg" => [
                "text" => "You can also sign in without verifying.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              "messages.register.invitation.invalid.msg" => [
                "text" => "The invitation link is invalid or already expired.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 0
              ],
              "messages.register.referral.code.invalid.msg" => [
              ...
              "messages.unverified.users.delete" => [
                "text" => ":what deleted!",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              "messages.unverified.users.delete_failed" => [
                "text" => ":what deletion failed!",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              ...
              "messages.stage_move" => [
                "text" => "The stage has been :status successfully!",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              ...
              "messages.pending_stage_delete" => [
                "text" => "This stage can't be deleted as it has pending transactions.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              ...
              "messages.permission" => [
               ...
               "messages.active.success" => [
                "text" => ":what has been activated.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              "messages.active.failed" => [
                "text" => ":what active has been failed!",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              "messages.inactive.success" => [
                "text" => ":what has been inactivated.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              "messages.inactive.failed" => [
                "text" => ":what inactivate has been failed!",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
            ...
            ///// AUTH PUBLIC /////
              ...
              "auth.social_private_sale_not_registered" => [
                "text" => "You have not registered yet in our platform.",
                "pages" => "auth",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// USER KYC /////
              ...
              "profile.change_email_title" => [
                "text" => "Change Email",
                "pages" => "user_profile",
                "panel" => "user",
                "load" => 0
              ],
              "profile.verify_email_address_title" => [
                "text" => "Verify Email Address",
                "pages" => "user_profile, dashboard",
                "panel" => "user",
                "load" => 0
              ],
              "profile.change_email_address" => [
                "text" => "Your current email is :email. If you want to change it, a verification link will be sent to your new requested email. Once verified, your email will update accordingly.",
                "pages" => "user_profile",
                "panel" => "user",
                "load" => 0
              ],
              "profile.change_new_email" => [
                "text" => "Your current email is :email, but there's a pending email change request to :new_email awaiting verification. Simply verify the new email to update your email.",
                "pages" => "user_profile",
                "panel" => "user",
                "load" => 0
              ],
              "profile.verify_email_address" => [
                "text" => "Please verify your email :email as it has not been verified yet.",
                "pages" => "user_profile, dashboard",
                "panel" => "user",
                "load" => 0
              ],
              "Profile.resend_verification_text" => [
                "text" => "Resend the verification email if you haven't received it.",
                "pages" => "user_profile",
                "panel" => "user",
                "load" => 0
              ],
              "Profile.resend_verification_email" => [
                "text" => "Resend Email",
                "pages" => "user_profile",
                "panel" => "user",
                "load" => 0
              ],
              "Profile.wrong_email_text" => [
                "text" => "If you registered with wrong email address, change it now.",
                "pages" => "user_profile",
                "panel" => "user",
                "load" => 0
              ],
              "Profile.new_email_placeholder" => [
              ...
              "Profile.email_not_sent_warning" => [
                "text" => "If you don't verify your email, you may not receive any email from us. To ensure account access, please verify your email.",
                "pages" => "user_profile",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// USER BUY TOKEN /////
              ...
              "buy_token.add.receive.wallet" => [
                "text" => "Before proceed to purchase token, please add your receiving wallet address. In order to receive your token, the wallet address is mandatory.",
                "pages" => "buy_token",
                "panel" => "user",
                "load" => 0
              ],
              "buy_token.click.add.wallet" => [
                "text" => "Click here to add wallet",
                "pages" => "buy_token",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// PAYMENT ONLINE /////
              ...
              "payment.refund_stage_status" => [
                "text" => "Refund not possible as the stage has been deleted.",
                "pages" => "payment, online",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "payment.refund_not_enough_token_balance" => [
                "text" => "This transaction cannot be refunded as user might not have enough token balance.",
                "pages" => "payment, online",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// TRANSACTION /////
              ...
              "tranx.already.canceled" => [
                "text" => "Transaction status updated. Please refresh and try again.",
                "pages" => "transaction, global",
                "panel" => "any",
                "load" => 0
              ],
              "tranx.already.approved" => [
                "text" => "Your order has experienced a change in status. Refresh the page to see the latest details and proceed if possible.",
                "pages" => "transaction, global",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// REFERRAL /////
              ...
              "referral.referral_id_invalid_msg" => [
                "text" => "This referral code is invalid. If you don't have a valid code, you can also register by keeping this field empty.",
                "pages" => "referral",
                "panel" => "user",
                "load" => 0
              ],
              "referral.valid_code_required" => [
                "text" => "A valid referral code is required.",
                "pages" => "referral",
                "panel" => "user",
                "load" => 0
              ],
