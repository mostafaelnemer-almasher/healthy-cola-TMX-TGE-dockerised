<div class="payment-card">
    <div class="payment-head">
        ...
        <div class="payment-logo">
            <img src="{{ asset('assets/images/pay-stripe-admin.png') }}" alt="Stripe">
        </div>
        <div class="payment-action">
            ...
            <div class="toggle-class dropdown-content dropdown-content-top-left">
                <ul class="dropdown-list">
                    ...
                    <li><a class="quick-action" href="javascript:void(0)" data-name="stripe">{{ $pmData->status == 'active' ? 'Disabled' : 'Enabled' }}</a></li>
                </ul>
            </div>
        </div>
    </div>{{-- .payment-head --}}
    <div class="payment-body">
        <h5 class="payment-title">Stripe Payment Gateway</h5>
        <p class="payment-text">Accept payments via Stripe account from contributors.</p>
    ...
    <div class="payment-footer">
        ...
        @else
        <span class="payment-id-title">Stripe Account </span>
