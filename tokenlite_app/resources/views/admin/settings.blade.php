                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-lg-3 col-sm-6">
                                            <div class="input-item input-with-label">
                                                ...
                                                <span class="input-note"><strong>'Invite Only'</strong> option will work only when <strong>'Private Sale'</strong> is enabled.</span>
                                            </div>
                                        </div>
                                        <div class="col-md-8 col-lg-6 col-sm-12">
                                            <div class="input-item input-with-label">
                                                <label class="input-item-label">Email Verification</label>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="input-wrap">
                                                            <select name="email_verification_disable" id="email_verification_disable" class="select select-block select-bordered">
                                                                    @foreach (config('icoapp.verification_type') as $type_value => $type_name)
                                                                <option value="{{ $type_value }}" {{(get_setting('email_verification_disable') == $type_value) ? 'selected ':''}}>{{$type_name}}</option>
                                                                    @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="input-wrap input-wrap-checkbox mgt-1x">
                                                            <input class="input-checkbox input-checkbox-sm" type="checkbox" name="mail_to_unverified_user" id="mail_to_unverified_user" {{ get_setting('mail_to_unverified_user') == 1 ? 'checked' : '' }}>
                                                            <label for="mail_to_unverified_user">Send Email To Unverified User</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <span class="input-note">User will be not required to verify their email if disable.</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="input-item input-with-label">
                                                ...
                                                <textarea name="disable_reg_msg" class="input-bordered textarea-reg-disable invite-input-text" id="disable-reg-msg" rows="2">{{ get_setting('disable_reg_msg') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="gaps-1x"></div><div class="sap"></div><div class="gaps-3x"></div>
