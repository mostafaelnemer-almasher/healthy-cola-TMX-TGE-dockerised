                ...
                <ul class="data-details-list">
                    ...
                    <li>
                        ...
                        <div class="data-details-des justify-content-start" >
                            {!! count($refered).' Contributors' !!}
                            <a href="javascript:void(0)" data-uid="{{ $user->id }}" data-type="referrals" class="user-form-action user-action ml-3 font-mid">(View)</a>
                        </div>
                    </li>{{-- li --}}
                    @endif
                    <li>
                        <div class="data-details-head">Private Invite Code</div>
                        <div class="data-details-des">{!! ($invCode != NULL) ? '<span>'.$invCode->value.'</span>' : '<small class="text-light">Join without invitation!</small>' !!}</div>
                    </li>{{-- li --}}
                    <li>
                    ...
                    <li>
                        ...
                        <div class="data-details-des">{!! $user->lastLogin && ($user->email_verified_at !== null || gws('email_verification_disable') == 1) ? _date($user->lastLogin) : '<small class="text-light">Not logged yet!</small>' !!}</div>
                    </li>{{-- li --}}
                </ul>
            </div>{{-- .card-innr --}}
        </div>{{-- .card --}}
