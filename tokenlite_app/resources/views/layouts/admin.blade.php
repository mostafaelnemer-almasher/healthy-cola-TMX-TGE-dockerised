                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="topbar-logo">
                        <a href="{{ url('/')}}" class="site-brand">
                            ...
                            @else
                                <img height="40" src="{{ site_whitelabel('logo') }}" srcset="{{ site_whitelabel('logo2x') }}" alt="{{ site_whitelabel('name') }}">
                            @endif
                        </a>
                    </div>
                    <ul class="topbar-nav">
                    ...
                    <ul class="navbar-menu" id="main-nav">
                        ...
                        <li class="has-dropdown"><a class="drop-toggle" href="javascript:void(0)"><em class="ikon ikon-settings"></em> Settings</a>
                            <ul class="navbar-dropdown">
                                ...
                                <li><a href="{{ route('admin.private.invite.list') }}"> Private Sale Invitation</a></li>
...
@php
    ...
    $route_urls = [
        ...
        'stage_delete_url' => 'admin.ajax.stages.delete',
        'stage_archive_url' => 'admin.ajax.stages.archive',
        ...
        'private_invite_url' => 'admin.ajax.private.invite.modal_show',
        'invite_update_url' => 'admin.ajax.private.invite.update',
    ];
