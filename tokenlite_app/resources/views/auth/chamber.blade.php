                ...
                <div class="content-area card">
                    <div class="card-innr">
                        <div class="card-head wide-max-lg pb-0">
                            ...
                            <p class="mt-2">TMX-TGE is now installed and ready to use. <strong>Your application must be registered to unlock all the features and activate the app.</strong> Please follow the instruction below to provide your purchase code and register the application.</p>
                        ...
                        <div class="card-text">
                            <div class="row guttar-50px guttar-vr-30px">
                                <div class="col-lg-4 order-lg-last">
                                    <p class="alert alert-danger fs-13"><strong>Important:</strong> As per <a href="https://codecanyon.net/licenses/standard" target="_blank">Envato License</a> terms, one purchase code is valid for install to one domain. So please install the TMX-TGE into correct domain to avoid any kind of issues.</p>
