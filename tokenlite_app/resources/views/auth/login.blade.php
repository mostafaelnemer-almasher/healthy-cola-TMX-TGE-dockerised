...
<div class="page-ath-form">
    ...
    <ul class="row guttar-20px guttar-vr-20px">
        ...
        env('FB_CLIENT_SECRET', '')) != '')
        <li class="col"><a href="{{ gws('private_invitation_active')==1 && isset($invite_code) ? route('social.login', ['facebook', 'invite' => $invite_code]) : route('social.login', 'facebook') }}"
        ...
        <li class="col"><a href="{{ gws('private_invitation_active')==1 && isset($invite_code) ? route('social.login', ['google', 'invite' => $invite_code]) : route('social.login', 'google') }}"
